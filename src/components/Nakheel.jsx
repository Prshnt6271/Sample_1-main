...
const images = [one, two, three, four, five, four, one, two, three, four, three, two];
  ...
  return (
    <div className="relative min-h-screen">
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-0"> {/* Removed all gaps between images */}
          {images.map((src, index) => (
            <div key={index} className="relative group overflow-hidden w-full h-[280px] sm:h-[260px] md:w-[360px] md:h-[280px] mt-3">
